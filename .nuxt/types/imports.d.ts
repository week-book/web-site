...
declare global {
  ...
  const loadPost: typeof import('../../utils/loadPosts').loadPost
  const loadPosts: typeof import('../../utils/loadPosts').loadPosts
...
declare global {
  ...
  // @ts-ignore
  export type { PostMeta, PostSummary, Post } from '../../utils/loadPosts'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly loadPost: UnwrapRef<typeof import('../../utils/loadPosts')['loadPost']>
    readonly loadPosts: UnwrapRef<typeof import('../../utils/loadPosts')['loadPosts']>
